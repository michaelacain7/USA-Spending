...
class Config:
    ...
    # Market Hours Settings (disabled by default - run 24/7)
...
def main():
    ...
    parser.add_argument('--market-hours', action='store_true', help="Only run during market hours (9:30-4 ET)")
    parser.add_argument('--all-hours', action='store_true', help="(Default) Run 24/7 - kept for compatibility")
    ...
    config.market_hours_only = args.market_hours  # Only True if --market-hours flag used
