...
class Config:
    ...
    # Monitoring Settings
    # 1000 requests/day limit, 14 hours of operation
    # 90 seconds = 560 requests/day (56% of quota) - safe margin
    check_interval_seconds: int = 90
    lookback_days: int = 7  # Fetch 7 days of awards (handles weekends)
    
    # Operating Hours Settings (6:00 AM - 8:00 PM ET on weekdays)
...
class CombinedContractMonitor:
    ...
    def run_continuous(self):
        ...
        if self.config.market_hours_only:
            print("  Mode: Weekdays 6:00 AM - 8:00 PM ET")
        else:
            print("  Mode: 24/7")
...
def main():
    ...
    parser.add_argument('-i', '--interval', type=int, default=90, help="Check interval in seconds")
