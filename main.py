...
class CombinedContractMonitor:
    ...
    def check_once(self) -> List[Tuple[Dict, Dict, Dict]]:
        ...
        for award in all_awards:
            ...
            # NOTE: We removed date filtering because USAspending API already filters 
            # by transaction date. The date_signed field is when the contract was 
            # ORIGINALLY signed (could be years ago), not when recent activity occurred.
        ...
        self.logger.info(f"  Stats: total={stats['total']}, seen={stats['seen']}, low_value={stats['low_value']}, no_match={stats['no_match']}, low_mat={stats['low_materiality']}, no_mcap={stats['no_market_cap']}")
