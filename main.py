...
class Config:
    ...
    # Monitoring Settings
    # 1000 requests/day limit - using 3 min interval for safety
    # 14 hours * 20 req/hr = 280 requests/day (28% of quota)
...
def main():
    ...
    parser.add_argument('-i', '--interval', type=int, default=180, help="Check interval in seconds")
